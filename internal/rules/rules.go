...
var reOpenAISecret = regexp.MustCompile(`\bsk-[A-Za-z0-9]{20,200}\b`)
var reAnthropicSecret = regexp.MustCompile(`\bsk-ant-[A-Za-z0-9-]{20,200}\b`)
var reGitHubPATClassic = regexp.MustCompile(`\bghp_[A-Za-z0-9]{36}\b`)
var reGitHubPATFineGrained = regexp.MustCompile(`\bgithub_pat_[A-Za-z0-9_]{20,200}\b`)
var reSlackToken = regexp.MustCompile(`\bxox[baprs]-[A-Za-z0-9-]{10,200}\b`)
